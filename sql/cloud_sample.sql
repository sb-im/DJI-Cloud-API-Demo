...
VALUES
	...
	(27, 3, 2, 0, 'DJI Dock 2', NULL),
	(28, 0, 91, 0, 'M3D', NULL),
	(29, 0, 91, 1, 'M3TD', NULL),
	(30, 1, 80, 0, 'M3D Camera', NULL),
	(31, 1, 81, 0, 'M3TD Camera', NULL),
	(32, 1, 88, 0, 'M4E Camera', NULL),
	(33, 1, 89, 0, 'M4T Camera', NULL),
	(34, 1, 90, 0, 'M4D Camera', 'Mavic 4 Dual Camera'),
	(35, 1, 91, 0, 'M4TD Camera', 'Mavic 4 Thermal Dual Camera'),
	(36, 1, 176, 0, 'Vision Assist', '辅助影像相机'),
	(37, 0, 99, 0, 'M4E', 'Mavic 4 Enterprise'),
	(38, 0, 99, 1, 'M4T', 'Mavic 4 Thermal'),
	(39, 0, 100, 0, 'M4D', 'Mavic 4 Dual'),
	(40, 0, 100, 1, 'M4TD', 'Mavic 4 Thermal Dual'),
	(41, 0, 103, 0, 'DJI Matrice 400', 'DJI Matrice 400 系列'),
	(42, 3, 88104, 0, 'S25M4', 'M4-25'),
	(43, 3, 88105, 0, 'S25M400', 'M400充电'),
	(44, 3, 88106, 0, 'S25M400Pro', 'M400Pro换电'),
    -- 以下为补充的缺失项 --
	(45, 1, 31, 0, 'Payload', 'Generic Payload'),
	(46, 1, 50, 0, 'L1', 'Zenmuse L1 (Type 50)'),
	(47, 1, 60, 0, 'DJI Mini 3 Pro Camera', NULL),
	(48, 1, 76, 0, 'DJI Mini 3 Camera', NULL),
	(49, 1, 82, 0, 'H30', 'Zenmuse H30'),
	(50, 1, 83, 0, 'H30T', 'Zenmuse H30T'),
	(51, 1, 84, 0, 'L2', 'Zenmuse L2'),
	(52, 1, 65535, 0, 'Not Supported', NULL),
	(53, 1, 100000, 0, 'P1', 'Zenmuse P1 (Type 100k)'),
	(54, 3, 88097, 0, 'S22M300', 'M300机场'),
	(55, 3, 88098, 0, 'S2201', '机场 2 (S2201)'),
	(56, 3, 88099, 0, 'S2301', 'M3机场'),
	(57, 3, 88100, 0, 'S24M350', 'M350机场-24'),
	(58, 3, 88101, 0, 'S24M350S', 'M350换电机场-24'),
	(59, 3, 88102, 0, 'S24M3', 'M3机场-24'),
	(60, 3, 88103, 0, 'S24M4', 'M4机场-24');
